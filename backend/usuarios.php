...
if ($_SESSION['tipo_usuario'] != 'funcionario') {
    header("Location: login.php"); // Si no es funcionario, redirigir al login
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['agregar_usuario'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO usuarios (nombre, documento, email, clave) 
...
<head>
    ...
    <title>Gestión de Usuarios - Kamkuama IPS</title>
...
<div class="header">
    <h2>Gestión de Usuarios - Kamkuama IPS</h2>
</div>
            ...
            <tbody>
                <?php foreach ($usuarios as $usuario): ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_usuario.php?id=<?php echo $usuario['id']; ?>" class="btn btn-warning">
